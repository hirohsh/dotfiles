-- core utils by ryoppippi
--@see https://github.com/ryoppippi/dotfiles/blob/main/nvim/lua/core/utils.lua
...
M.open_file_with_quicklook = function(path)
    ...
    vim.defer_fn(function()
        ...
        "osascript",
        "-e",
        'tell application "System Events" to tell process "QuickLookUIService" to set frontmost to true'
        }, { detach = true })
    end, 100) -- 少し待ってから前面化
end
