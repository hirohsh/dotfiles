-- oil actions.lua by ryoppippi
--@see https://github.com/ryoppippi/dotfiles/blob/main/nvim/lua/plugins/oil/actions.lua
...
local openNewWeztermPane = function(opt)
	local _opt = opt or {}
	local percent = _opt.percent or 50
...
local function pick_preview_cmd()
